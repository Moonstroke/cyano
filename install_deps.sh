...
sudo apt-get install --yes libasound2-dev libdbus-1-dev libegl1-mesa-dev\
                           libgl1-mesa-dev libgles2-mesa-dev libglu1-mesa-dev\
                           libibus-1.0-dev libmirclient-dev libpulse-dev\
                           libsdl2-2.0-0 libsndio-dev libudev-dev libwayland-dev\
